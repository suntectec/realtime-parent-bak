 ...
 * @usage
 */
public class LocalKeyByFlatMapFunction extends RichFlatMapFunction<Tuple2<String, Long>, Tuple2<String, Long>> implements CheckpointedFunction {
    ...
    // 构造器，批次大小传参
    public LocalKeyByFlatMapFunction(int batchSize) {
